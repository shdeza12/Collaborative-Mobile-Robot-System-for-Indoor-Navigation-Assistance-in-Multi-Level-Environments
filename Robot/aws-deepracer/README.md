> **Nota de esta copia:** Esta es una versión adaptada del repositorio original
> [aws-deepracer/aws-deepracer](https://github.com/aws-deepracer/aws-deepracer),
> migrada a ROS 2 Humble en el marco del proyecto de grado *Sistema colaborativo
> de robots móviles para asistencia de orientación en entornos interiores con
> múltiples pisos* (Universidad Santo Tomás). La carpeta `media/` con imágenes
> y GIFs de demostración fue removida para reducir el peso del repositorio.
> Las modificaciones aplicadas se documentan en el `README.md` de la carpeta
> `Robot/` (un nivel arriba). Se conservan la licencia Apache 2.0 y el archivo
> NOTICE originales.
