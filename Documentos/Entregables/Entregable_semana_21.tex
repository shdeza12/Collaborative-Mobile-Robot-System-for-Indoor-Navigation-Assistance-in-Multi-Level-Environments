...
El registro audiovisual de la campaña documenta la ejecución de las treinta misiones descritas en la sección~\ref{sec:campana}. Las cifras de este informe no salen del video sino de los treinta registros JSON versionados en el repositorio; el video es evidencia de que las corridas ocurrieron, no la fuente de las métricas.

\begin{thebibliography}{99}

\bibitem{video_campana}
S. Hernández Ávila y J. A. Mejía León,
``Evidencia Semana 21 --- Campaña de 30 misiones de prueba,''
Registro audiovisual, septiembre de 2026. [Online]. Available: \url{https://youtu.be/eH_Co4vZZdw}

\bibitem{registros_campana}
S. Hernández Ávila,
``Registros de la campaña OE4 en simulación y métricas agregadas,''
Repositorio del proyecto, \texttt{Documentos/Evidencia/registros/} y
\texttt{Documentos/Evidencia/S21\_metricas\_campana\_oe4.json}, septiembre de 2026.
